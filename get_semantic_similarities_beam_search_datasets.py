...
if f"{args.generation_model}" in opt_models:
    hf_model_dir = 'facebook/' + f"{args.generation_model}"

if f"{args.generation_model}" in gemma_models:
    hf_model_dir = 'google/' + f"{args.generation_model}"

if f"{args.generation_model}" in falcon_models:
    hf_model_dir = 'tiiuae/' + f"{args.generation_model}"
